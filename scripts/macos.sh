...
sudo scutil --set ComputerName "chriskjaer"
sudo scutil --set HostName "chriskjaer"
sudo scutil --set LocalHostName "chriskjaer"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "chriskjaer"
